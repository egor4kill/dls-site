...
export default function registerPreview(CMS) {
  const h = React.createElement;
  const siteBase = window.location.pathname.replace(/\/admin\/?$/, "");
  const siteUrl = path => siteBase + path;
    ...
    return h("header", { className: "site-header" },
      h("div", { className: "container header-inner" },
        h("a", { className: "brand", href: siteUrl("/"), "aria-label": "Движение либеральных сил — на главную" },
          ...
          h("span", { className: "brand-text" }, h("b", null, "ДЛС"), h("span", null, "Движение либеральных сил"))
        ),
        h("nav", { className: "site-nav", "aria-label": "Основное меню" },
          h("ul", null,
            ...
            h("li", { className: "nav-cta" }, h("a", { className: "cta-btn cta-btn--compact", href: "https://t.me/dls_force" }, "В движение ", h("span", { "aria-hidden": "true" }, "↗")))
          )
        )
      )
    );
  ...
  function Footer() {
    return h("footer", { className: "site-footer" },
      h("div", { className: "container footer-inner" },
        h("a", { className: "foot-brand", href: siteUrl("/") }, h("span", { className: "foot-monogram", "aria-hidden": "true" }, "ДЛС"), h("span", null, "ДЛС — Движение либеральных сил")),
        h("nav", { className: "foot-links", "aria-label": "Меню в подвале" },
          h("a", { href: siteUrl("/") }, "Главная"), h("a", { href: siteUrl("/news/") }, "Новости"), h("a", { href: siteUrl("/#pillars") }, "Принципы"), h("a", { href: siteUrl("/#society") }, "Общество")
        ),
          ...
          h("article", { className: "article" },
            h("div", { className: "container container--article" },
              ...
              h("header", { className: "article-header" },
                ...
                h("div", { className: "article-meta" }, h("time", null, formatDate(date)), author ? h("span", { className: "article-author" }, "Автор: " + author) : null)
              ),
